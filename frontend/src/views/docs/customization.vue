  ...
  <Layout>
    ...
    <div class="flex flex-col gap-6">
      <div class="card">
        ...
        <div class="p-6">
          <p> You can change the colour palette of any demo very easily by simply changing the few SCSS variables' value.</p>

          <p>
            In order to modify the colors in existing themes, open
            the <code>_theme-config.scss</code> file from
      ...
      <div class="card">
        ...
        <div class="p-6">
          <p class="mb-4">
            ...
            attribute on <code>html</code> element in your file
          </p>
      ...
      <div class="card">
        ...
        <div class="p-6">
          <p>
            ...
            <code>views/pages/starter.vue</code>). It allows you
          ...
          <ul>
            ...
            <li>
              ...
              files in your page. Please check corresponding
